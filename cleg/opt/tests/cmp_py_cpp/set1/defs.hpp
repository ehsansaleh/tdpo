...
#define inner_loops_per_outer_loop 1     // (inner_loop_rate / outer_loop_rate)
#define physics_loops_per_inner_loop 1   // (inner_step_time / physics_timestep)
#define obs_dim 4                        // (4 * obs_history_len_int + contact_obs_int +
...
#define fc1_size  256                    // (obs_dim * h1)
